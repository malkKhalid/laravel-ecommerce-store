...
<head>
    ...
    <title>{{"Register-Page| " . env('APP_NAME')}}</title>
    ...
    <style>
        ...
        .overlay {
            ...
            /* with sign-in */
            /* clip: rect(0, 900px, var(--form-height), 515px); */
        }
        ...
        <div class="form">
            <div class="sign-in" id="sign-in-info">
                ...
                <form id="sign-in-form" method="POST" action="{{ route('login') }}">
                    @csrf
                    <input type="string" class=" @error('email') is-invalid @enderror" name="email"
                        value="{{ old('email') }}" required autocomplete="email" autofocus
                        placeholder="Email Or Phone" />
                    @error('email')
                        <small class="invalid-feedback d-block" style="color: red" role="alert">
                            {{ $message }}
                        </small>
                    @enderror
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class=" btn btn-link forgot-password">Forgot your
                            password?</a>
                    @endif
            ...
            <div class="sign-up" id="sign-up-info">
                ...
                <form id="sign-up-form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    {{-- <select name="type" class="form-control @error('type') is-invalid @enderror">
                        ...
                        <option   value="user">Coustomor</option>
                        <option   value="author">Author</option>
                        <option   value="seller">Seller</option>
                    </select> --}}


                    {{-- <input placeholder="Phone"type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone"/>
                    @error('phone')
                    <small class="invalid-feedback" style="color: red" role="alert">
                        {{ $message }}
                    </small>
