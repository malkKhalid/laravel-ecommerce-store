...
@section('title',"all_category | " . $settings->store_name)
                    ...
                    <div class="widget category-list">
                        ...
                        <ul class="category-list">
                            @foreach ($categories as $category )
                                <li class="active"><a href="{{route('site.category',$category->id )}}">{{$category->$name}} <span>{{$category->products->count()}}</span></a></li>
                            @endforeach
                        </ul>
                    </div>
                                    ...
                                    <div class="card">
                                        <div class="thumb-content">
                                            ...
                                            <a href="{{route('site.category',$category->id)}}">
                                                <img class="card-img-top img-fluid" src="{{asset('uploads/categories/' . $category->image)}}"
                                                    alt="Card image cap">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h4 class="card-title"><a href="{{route('site.category',$category->id)}}">{{$category->$name}}</a></h4>
                                            <ul class="list-inline product-meta">
                                                
                                                <li class="list-inline-item">
                                                    <a href="category.html"><i class="fa fa-calendar"></i>{{$category->created_at->format('jS F')}}</a>
                                                </li>
                                            </ul>
